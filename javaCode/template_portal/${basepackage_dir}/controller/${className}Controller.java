...
package ${basepackage}.portal.controller;
...
public class ${className}Controller extends BaseController{
	...
	public ModelAndView save(${className} ${classNameLowerCase},RedirectAttributes attr) {
		ModelAndView mv = new ModelAndView("redirect:/${classNameFirstLower}/list");
		
		<#list table.columns as column>
		<#if column.pk>
		if(${classNameLowerCase}.get${column.columnName}() == null){
			${classNameFirstLower}Service.save(${classNameLowerCase});
			attr.addFlashAttribute("success", "添加成功!");
			
			logger.debug("创建成功");
		}else{
			${classNameFirstLower}Service.dynamicUpdate(${classNameLowerCase});
	...
	public ModelAndView delete(${className}Query query,RedirectAttributes attr) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException, IntrospectionException {
		...
		<#list table.columns as column>
		<#if column.pk>
		${classNameFirstLower}Service.deleteById(query.get${column.columnName}());
		query.set${column.columnName}(null);
